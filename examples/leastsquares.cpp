    ...
    ScalarType delta)
{
    ...
    else
    {
...

        {
            ...
            auto solution = regressor.fit(MatData, m, n, Vect, matrixIsCovariance);
...
int main()
{
    ...
    const auto delta = static_cast<Scalar>(0.5);//static_cast<Scalar>(2.5);// static_cast<Scalar>(0.1);//static_cast<Scalar>(-1); //
